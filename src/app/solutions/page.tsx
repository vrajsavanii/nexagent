      ...
      <section className="max-w-7xl mx-auto px-6 lg:px-10 pt-10 pb-16 border-b border-[rgba(205,211,219,0.5)]">
        ...
        <FadeIn>
          ...
          <h1 className="font-sans text-4xl sm:text-5xl lg:text-6xl font-black uppercase tracking-tight text-[#2A2B2E] max-w-4xl leading-[1.08]">
            ...
            <span className="font-light italic text-[#9E7B78]">REAL BUSINESS WORK.</span>
          </h1>
        ...
        <StaggerContainer className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {filteredSolutions.map((sol) => (
            <StaggerItem key={sol.id}>
              <div className="bg-white rounded-3xl border border-[rgba(205,211,219,0.5)] p-8 shadow-[0_10px_28px_-4px_rgba(42,43,46,0.05)] hover:border-[#9E7B78]/40 transition-all flex flex-col justify-between h-full space-y-6">
                <div>
