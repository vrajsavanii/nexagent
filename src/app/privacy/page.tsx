        ...
        <div className="bg-white rounded-3xl border border-[rgba(205,211,219,0.6)] p-8 sm:p-14 shadow-sm space-y-8">
          ...
          <div className="prose prose-sm max-w-none text-[#5E6572] space-y-6 leading-relaxed">
            ...
            <section className="space-y-3">
              ...
              <div className="p-4 bg-[#FBF5F3] border-l-4 border-[#EB572C] rounded-r-xl">
            ...
            <section className="space-y-3">
              ...
              <p>
                For questions regarding this policy or to request access, correction, or deletion of your contact data, please contact our team via our <Link href="/contact" className="text-[#EB572C] underline">Contact Page</Link>.
              </p>
            </section>
          </div>
        </div>
