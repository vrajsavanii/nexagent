    ...
    <section className="w-full py-20 bg-[#FBF5F3]">
      <div className="max-w-6xl mx-auto px-6">
        <div className="relative rounded-3xl bg-[#2A2B2E] p-10 sm:p-16 text-center text-white overflow-hidden shadow-[0_20px_50px_-10px_rgba(42,43,46,0.3)]">
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[450px] h-[450px] bg-radial-gradient from-[#9E7B78]/20 via-transparent to-transparent rounded-full blur-3xl pointer-events-none" />
          ...
          <div className="relative z-10 max-w-2xl mx-auto space-y-6">
            ...
            <div className="pt-4 flex flex-wrap items-center justify-center gap-4">
              <Link
                ...
                className="inline-flex items-center gap-2 px-8 py-3.5 rounded-2xl bg-[#9E7B78] hover:bg-[#8C6558] text-white text-sm font-bold shadow-[0_10px_25px_-4px_rgba(158,123,120,0.5)] transition-all transform hover:-translate-y-0.5"
              >
