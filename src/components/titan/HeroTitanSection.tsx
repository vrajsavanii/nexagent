...
export default function HeroTitanSection() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[650px] h-[650px] bg-gradient-to-tr from-[#EB572C]/8 via-[#EB572C]/4 to-transparent rounded-full blur-3xl pointer-events-none" />
      ...
      >
        <span className="px-2 py-0.5 rounded-full bg-[#EB572C] text-[10px] font-bold tracking-wide uppercase">
          New
        </span>
        ...
        >
          <div className="relative px-7 py-3 sm:px-9 sm:py-4 rounded-2xl bg-white border border-[rgba(205,211,219,0.5)] shadow-[0_16px_36px_-6px_rgba(42,43,46,0.14),0_4px_12px_rgba(0,0,0,0.04)] flex items-center gap-3 transform -rotate-2 hover:rotate-0 transition-transform duration-300">
            ...
            <div className="flex items-center gap-1">
              <span className="w-2 h-2 rounded-full bg-[#EB572C] animate-pulse" />
            </div>
            {/* Geometric Brand Icon */}
            <div className="w-7 h-7 rounded-md bg-[#2A2B2E] flex items-center justify-center shadow-xs">
              <svg viewBox="0 0 24 24" className="w-4 h-4 text-[#EB572C]" fill="currentColor">
      ...
      >
        <Link
          ...
          className="inline-flex items-center gap-2 px-8 py-3.5 rounded-2xl bg-[#EB572C] hover:bg-[#D63D10] text-white text-sm font-bold shadow-[0_10px_25px_-4px_rgba(235,87,44,0.45)] hover:shadow-[0_14px_32px_-4px_rgba(235,87,44,0.55)] transition-all transform hover:-translate-y-0.5"
        >
