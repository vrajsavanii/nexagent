...
import { ArrowRight, Briefcase, Cpu, Repeat, ShieldCheck } from "lucide-react";
    ...
    <section className="relative w-full py-20 lg:py-32 bg-white border-b border-slate-200/80">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
          ...
          <div className="p-8 sm:p-10 rounded-2xl bg-surface-ground border border-slate-200/90 shadow-2xs flex flex-col justify-between">
            <div>
          ...
          <div className="p-8 sm:p-10 rounded-2xl bg-surface-ground border border-slate-200/90 shadow-2xs flex flex-col justify-between">
            <div>
              <div className="flex items-center justify-between mb-6">
                <div className="p-3 rounded-xl bg-titanium-50 text-titanium-700">
        ...
        <div className="p-6 rounded-xl bg-slate-900 text-white flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            <Repeat className="w-5 h-5 text-brand-400 shrink-0" />
