      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          {featuredSolutions.map((sol) => (
            <div
              key={sol.id}
              className="flex flex-col justify-between p-7 rounded-2xl bg-surface-ground border border-slate-200/90 shadow-2xs hover:border-brand-400 hover:shadow-premium transition-all duration-300"
            >
              <div>
                ...
                <div className="flex flex-col gap-1.5 pt-3 border-t border-slate-200/70">
                  ...
                  {sol.typicalApplications.slice(0, 3).map((app, idx) => (
              ...
              <div className="mt-6 pt-4 border-t border-slate-200/60">
                <Link
                  ...
                  className="font-display text-xs font-semibold text-brand-800 hover:text-brand-950 flex items-center justify-between group"
                >
