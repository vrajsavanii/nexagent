  ...
  return (
    <section className="relative w-full py-20 lg:py-32 bg-white border-b border-slate-200/80">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <SectionHeader
          badgeText="08 / SCALE PROGRESSION"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-4 relative">
          {STAGES.map((stage, idx) => (
            <div
              key={stage.step}
              className="flex flex-col justify-between p-6 rounded-2xl bg-surface-ground border border-slate-200/80 shadow-2xs hover:border-brand-400 hover:shadow-premium transition-all duration-300 relative group"
            >
              <div>
                <div className="flex items-center justify-between mb-4">
                  ...
                  {idx < STAGES.length - 1 && (
                    <span className="text-slate-300 font-mono text-xs hidden lg:block">→</span>
                  )}
                </div>
