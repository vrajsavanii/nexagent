  ...
  return (
    <section className="relative w-full py-20 lg:py-32 bg-white border-b border-slate-200/80">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <SectionHeader
          badgeText="12 / OWNERSHIP & LEADERSHIP"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto mb-12">
          {COMPANY_DATA.founders.map((founder, idx) => (
            <div
              key={idx}
              className="p-8 rounded-2xl bg-surface-ground border border-slate-200/90 shadow-2xs hover:border-brand-400 hover:shadow-premium transition-all duration-300 flex flex-col justify-between"
            >
              <div>
