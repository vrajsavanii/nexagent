  ...
  return (
    <section className="relative w-full py-20 lg:py-32 bg-white border-y border-slate-200/80 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <SectionHeader
          badgeText="02 / BUSINESS COMPLEXITY"
        ...
        <div className="relative rounded-2xl border border-slate-200/90 bg-surface-ground p-6 sm:p-10 shadow-2xs">
          {viewMode === "connected" && (
            <div className="mb-8 p-4 rounded-xl bg-brand-50/80 border border-brand-200/80 flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            {TOOLS.map((tool) => {
              ...
              return (
                <div
                  key={tool.id}
                  className={cn(
                    "p-4 rounded-xl border transition-all duration-300 relative flex flex-col justify-between min-h-[140px]",
                    isConnected
                      ? "bg-white border-brand-200/80 shadow-2xs hover:border-brand-400 hover:shadow-subtle"
