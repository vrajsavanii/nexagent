        ...
        >
          ...
          <div className="hidden sm:flex items-center gap-3">
            <Link
              ...
              className="inline-flex items-center justify-center px-5 py-2 rounded-full text-xs font-bold text-white bg-[#9E7B78] hover:bg-[#8C6558] shadow-xs hover:shadow-sm transition-all"
            >
            ...
            >
              ...
              <div className="pt-3 border-t border-[rgba(205,211,219,0.3)]">
                <Link
                  href="/book-a-strategy-call"
                  onClick={() => setMobileMenuOpen(false)}
                  className="w-full inline-flex items-center justify-center py-2.5 rounded-full text-xs font-bold text-white bg-[#9E7B78] hover:bg-[#8C6558] shadow-sm transition-colors"
                >
                  Book a Strategy Call
                </Link>
              </div>
